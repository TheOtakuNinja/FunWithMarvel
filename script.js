...
//       <p> ${movieIronMan["releaseDate"]} </p>
//       <p> ${movieIronMan["releasePosition"]} </p>
//       <p> ${movieIronMan["description"]} </p>
//       <p> ${movieIronMan["budget"]} </p>
//       <p> ${movieIronMan["gross"]} </p>
//       <p> ${movieIronMan["rottenTomatoes"]} </p>
//       `
//       $("#display-area").append(ironmen)
//
...
for (var i = 0; i < movieListDetailed.length; i++) {
  ...
  `
      ...
      <p> Description: ${movieListDetailed[i]["description"]} </p>
      <p> Budget: ${movieListDetailed[i]["budget"]} </p>
      <p> Gross: ${movieListDetailed[i]["gross"]} </p>
      <p> RottenTomatoes: ${movieListDetailed[i]["rottonTomatoes"]} </p>
    </div>
  `
  $("#display-area").append(movieLister)
